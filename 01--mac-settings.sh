...
sudo -v
# Keep-alive: update existing `sudo` time stamp until scripts has finished
...
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "iMac"
